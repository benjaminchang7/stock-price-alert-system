...
![Screenshot 1](resources/p1.png)

![Screenshot 2](resources/p2.png)

![Screenshot 3](resources/p3.png)

![Screenshot 4](resources/p4.png)

![Screenshot 5](resources/p5.png)

![Screenshot 6](resources/p6.png)

[Watch the demo on Loom](https://www.loom.com/share/3a9070ec3e79488aa5f4e0c01c5543e6?sid=cc515863-2dcf-4a40-b5c2-91f649baff5f)

## Rubric Points
- **Working End-to-End Solution (25 points):**  
  All components are integrated to deliver a fully functional system. The Stock Data Service fetches and sends stock price updates; the Alert Management Service evaluates alert conditions and caches triggered alerts; the Portfolio Management Service maintains portfolio data; and the Web UI provides a unified interface.

- **Distributed Application (10 points):**  
  The solution comprises three distinct microservices plus a Web UI component, each handling a specific aspect of the overall business process.

- **Cloud Application (10 points):**  
  The application is designed to run on the cloud and leverages AWS services (SQS, DynamoDB, and ElastiCache for Redis).

- **Use of Key Technologies (15 points):**  
  This project utilizes:
    - **Messaging & Queuing:** AWS SQS for transmitting stock price updates.
    - **NoSQL Database:** AWS DynamoDB for storing alert conditions and portfolio data.
    - **Caching:** Redis for caching triggered alerts.

- **Completeness of Report & Detailed Architecture (15 points):**  
  This README outlines the system architecture (including the diagram above), details all API endpoints, and describes the integration of cloud logging/monitoring (console logging with potential AWS CloudWatch integration).

- **Source Code Inclusion (15 points):**  
  All source code for the microservices and the Web UI is included in the project repository.

- **Real-World Business Process (5 points):**  
  The system provides a practical solution for monitoring stock prices and triggering alerts based on user-defined conditions, resembling real-world investment decision support.

- **Monitoring (5 points):**  
  Each microservice logs its operations to the console, and the design allows for integration with AWS CloudWatch for production-level monitoring.
